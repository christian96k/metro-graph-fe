pipeline {
    ...
    environment {
        ...
        VM_DOCKER_COMPOSE_PATH = '/home/ubuntu/dockerfiles/docker-compose.yml'  // Percorso dove si trova docker-compose.yml sulla VM
    }
            ...
            steps {
                script {
                    ...
                    sshagent([VM_SSH_CREDENTIALS]) {
                        ...
                        sh "scp dockerfiles/docker-compose.yml ubuntu@${VM_IP}:${VM_DOCKER_COMPOSE_PATH}"

                        // Esegui il docker-compose sulla VM
                        sh "ssh ubuntu@${VM_IP} 'cd /home/ubuntu/dockerfiles && docker-compose -f docker-compose.yml up -d --build'"
                    }
                }
            }
        }
